...
def set_cfg_gt(cfg):
    ...
    cfg.gt.ffn_dropout = 0.0
    
    cfg.gt.global_dropout = 0.0
    cfg.gt.local_dropout = 0.0
    cfg.gt.external_dropout = 0.0
    cfg.gt.local_out_act = False
    ...
    # GEANet
    cfg.GEANet = CN()
    cfg.GEANet.edge_unit = False
    cfg.GEANet.shared_unit = False
    cfg.GEANet.n_heads = 4
    cfg.GEANet.unit_size = 4
